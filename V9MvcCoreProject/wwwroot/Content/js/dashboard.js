...
var KTDashboard = function() {
    ...
    var dailySales = function() {
        ...
        var chartData = {
            labels: ["Emirates", "Jumeirah ", "Dubai Airports", "Chalhoub Group", "Emirates National Oil Company (ENOC)", "DAMAC Properties", "DP World", "Sharaf DG", "Al Fardan Exchange", "Atkins Middle East", "Dubai Islamic Bank (DIB)", "Sharaf DG", "Chalhoub Group", "Careem", "Nakheel", "DP World"],
            datasets: [{
                //label: 'Dataset 1',
